...
public class QuizActivity4 extends AppCompatActivity {
    ...
    private void addQuestions() {
        ...
        questionsList.add(new QuestionModel("√f(x) = g(x) орындалу үшін қойылатын талап:", "g(x) ≥ 0", "g(x) ≤ 0", "g(x) ≠ 0", 1));
        questionsList.add(new QuestionModel("√x+10 = x - 2, x-?", "x = 1", "x = 4", "x = 6", 3));
        questionsList.add(new QuestionModel("Салыстырыңыз: a^0 ? 1^n", "=", "<", ">", 1));
